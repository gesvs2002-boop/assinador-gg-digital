...
async function generatePdf(){
  ...
  try{
    ...
    drawTextInRect(p1,font,v.nome,[109.9,602,523.2,619],{size:10});
    drawTextInRect(p1,font,v.cpf,[123.8,587,261.6,604],{size:9.2});
    ...
    drawTextInRect(p1,font,v.endereco,[192.5,572.5,523.2,589],{size:9});
    drawTextInRect(p1,font,v.telefone,[133.4,557.5,303.8,574],{size:9.2});
    drawTextInRect(p2,font,v.modalidades,[155.5,450,513.6,466.5],{size:9.5});
    drawTextInRect(p2,font,v.delegacao,[192,426,517,442.5],{size:9.5});
